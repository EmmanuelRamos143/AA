...
En esta sección se realizara un estudio usando el algoritmo FCM (\textit{Fuzzy C Means}) \textit{Clustering}, para determinar el riesgo de un ataque al corazón, en este estudio se realizara un prueba usando 303 observaciones se revisara el desempeño y la precisión con respecto a otro algoritmo ya conocido.
\end{abstract}
